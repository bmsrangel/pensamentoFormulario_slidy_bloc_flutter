...
class SmileyPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    var startPoint = Offset(widthRadius, rangeValue(minHeightEndPoint, maxHeightEndPoint, range));
    var controlPoint1 =
        Offset(size.width / 4, rangeValue(minHeightMiddlePoint, maxHeightMiddlePoint, range));
    var controlPoint2 =
        Offset(3 * size.width / 4, rangeValue(minHeightMiddlePoint, maxHeightMiddlePoint, range));
    var endPoint =
        Offset((size.width - widthRadius), rangeValue(minHeightEndPoint, maxHeightEndPoint, range));
